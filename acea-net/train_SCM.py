...
def train(paths_dict, model1, model2, transformation, criterion, device, save_path1, save_path2, logger, opt):
    ...
    loss_kd = KDLoss(opt.T)  # 创建一个知识蒸馏损失函数对象，其中opt.T是温度参数。
...
def parsing_data():
    ...
    parser.add_argument("--pretrained_model1_dir",
                    type=str,
                    default="./models/VS_MSD-not-spcaing/gatedcrfloss3d22d_multiview_varianceloss-0.31-unet1-0.3075-unt-0.3125-unet-0.31-unet-0.31-unet1-0.305-unet-0.315-unet-0.32-unet-0.31-unet-0.5-0.275-0.25-unet-0.3-unet-0.325-unet-0.5-0.325-0.5-0.32-0.5-0.33-0.5-0.34-0.5-0.36-0.5-0.25-0.5-0.4-0.5-0.35-0.5-0.2-0.5-0.3/",
    ...
    parser.add_argument("--model_dir",
                    type=str,
                    default="./models/VS_MSD-not-spcaing/gatedcrfloss3d22d_multiview_varianceloss-0.31-unet1-0.3075-unt-0.3125-unet-0.31-unet-0.31-unet1-0.305-unet-0.315-unet-0.32-unet-0.31-unet-0.5-0.275-0.25-unet-0.3-unet-0.325-unet-0.5-0.325-0.5-0.32-0.5-0.33-0.5-0.34-0.5-0.36-0.5-0.25-0.5-0.4-0.5-0.35-0.5-0.2-0.5-0.3/",   # ./models/debug/
