...
from utilities.losses import DC, CE, DC_CE, DC_CE_Focal, PartialLoss, SizeLoss, VarianceLoss, TightnessPrior, MumfordShah_Loss3D22D
...
def train(paths_dict, model, transformation, criterion, device, save_path, fold_dir, logger, opt):
    ...
    # MumfordShah
    MumfordShah_Loss3D22D_loss = MumfordShah_Loss3D22D()
    ...
    while continue_training:
        ...
        for phase in PHASES:
            ...
            running_loss_MumfordShah_Loss3D22D = 0.0
            ...
            for _ in tqdm(range(nb_batches[phase])):
                ...
                with torch.set_grad_enabled(phase == "training"):
                    ...
                    # print('55', inputs)
                    loss_MumfordShah_Loss3D22D = MumfordShah_Loss3D22D_loss(inputs, outputs)
                    # print(geodesic_labels, outputs)
...
#####################################################################
                        # DTP
                        loss = loss_seg + 0*loss_MumfordShah_Loss3D22D
 ##################################################################
                    else:
                        ...
                        # ###########################################################
                        loss_MumfordShah_Loss3D22D = torch.Tensor([0]).to(device)
                        loss = loss_seg + loss_MumfordShah_Loss3D22D
                ...
                running_loss_MumfordShah_Loss3D22D += loss_MumfordShah_Loss3D22D.item()
            ...
            epoch_loss_MumfordShah_Loss3D22D = running_loss_MumfordShah_Loss3D22D / epoch_samples
            ...
            writer.add_scalar("{0:}/loss_MumfordShah_Loss3D22D".format(phase), epoch_loss_MumfordShah_Loss3D22D, epoch)
            ...
            logger.info("{}  Loss MumfordShah_Loss3D22D: {:.4f}".format(
                phase, epoch_loss_MumfordShah_Loss3D22D))
