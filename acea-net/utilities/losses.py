...
class MumfordShah_Loss(nn.Module):
    def levelsetLoss(self, target, output, penalty='l1'):
        ...
        for ich in range(tarshape[1]):
            target_ = torch.unsqueeze(target[:, ich], 1)  # [48, 1, 128, 128]
            target_ = target_.expand(
                tarshape[0], outshape[1], tarshape[2], tarshape[3])  # [48, 2, 128, 128]
