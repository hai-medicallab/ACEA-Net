...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Crop VS_MSD-not-spcaing images and labels')
    parser.add_argument('--data_dir', type=str, default="./data/VS_MSD-not-spcaing/", help='(string) path to VS_MSD-not-spcaing images and labels')
    parser.add_argument("--dataset_split", type=str, default="./splits/split_VS_MSD.csv", help="Path to split file")
    ...
    for name in tqdm(list_file):
        ...
        print("img_arr shape: {0:}".format(img_arr.shape))
